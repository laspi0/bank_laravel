...
<div class="container-fluid">
    <form method="POST" action="{{ route('teller.store') }}">
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Créer un profil guichetier</strong>
                    </div>
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="national_id" class="col-md-4 col-form-label text-md-right">Carte nationale d'identité</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">Créer le profil teller</button>
                            </div>
                        </div>
                    </div>
                </div>
